...
**Phase 2 complete** (evaluators, sets, UI via #54–#56). Phase 1 Prompt Manager epic [#18](https://github.com/madmmas/aiplane/issues/18) is next — first slice is Prompt CRUD ([#50](https://github.com/madmmas/aiplane/issues/50)).
