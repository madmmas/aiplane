...
| [#49](https://github.com/madmmas/aiplane/issues/49) | Wire test execution + coverage into CI | `chore/ci-test-execution` | Hygiene | Open ([#72](https://github.com/madmmas/aiplane/pull/72)) |
